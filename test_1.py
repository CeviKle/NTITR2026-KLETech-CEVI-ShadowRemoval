...
parser.add_argument('--test_dir', type=str, default='/home/pegasus/Experiments/Nikhil/Shadow_R/ShadowDataset/test/')
parser.add_argument('--output_dir', type=str, default='/home/pegasus/Experiments/Nikhil/Shadow_R/results/')
